...
func InitRepositories(db postgres.DB, rdb *redisv9.Client) *Repositories {
	return &Repositories{
		...
		TransitGateway:   postgres.NewTransitGatewayRepository(db),
	}
}
...
type Services struct {
	...
	TransitGateway   *services.TransitGatewayService
}
